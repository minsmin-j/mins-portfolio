...
function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-white dark:bg-dark-mode shadow-sm">
      <div className="container mx-auto md:flex justify-between py-2 max-width">
      <div className="flex justify-between items-center py-2 md:py-4">
        <NavLink to="/">
          <span className="text-2xl font-bold text-dark-heading dark:text-light-heading">
            LeeJeongMin
          </span>
        </NavLink>
